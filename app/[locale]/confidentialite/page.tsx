  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        />
        <section className="max-w-4xl mx-auto px-(--spacing-container) py-12">
          <h2 className="text-xl font-medium mt-8 mb-3 text-(--color-gb-dark)">
          ...
          <p className="text-(--color-text-muted) leading-relaxed">
            ...
            <a
              ...
              className="text-(--color-gb-red) hover:underline"
            >
          ...
          <ul className="list-disc list-inside mt-2 space-y-1 text-(--color-text-muted) leading-relaxed">
            <li>
          ...
          <ul className="list-disc list-inside space-y-1 text-(--color-text-muted) leading-relaxed">
            <li>
