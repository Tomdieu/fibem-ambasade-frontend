...
export default async function ServicesPage() {
  ...
  const SERVICES = [
    {
      title: t("pages_content.visa.title"),
      description: "Demandez un visa pour la Guinée-Bissau : tourisme, affaires, transit ou séjour longue durée. Remplissez votre dossier en ligne.",
      href: "/services/visa",
      icon: FileText,
    },
    {
      title: t("pages_content.passport.title"),
      description:
    ...
    {
      title: t("pages_content.legalisation.title"),
      description:
    ...
    {
      title: t("pages_content.civil_registry.title"),
      description:
    ...
    {
      title: t("pages_content.inscription.title"),
      description:
  ...
  return (
    <>
      ...
      <main className="flex-1">
        <PageHero
          title={t("pages_content.services.title")}
          subtitle={t("pages_content.services.subtitle")}
          breadcrumbs={[
            { label: t("nav.home"), href: "/" },
            { label: t("pages_content.services.title") },
          ]}
        />
        <section className="max-w-7xl mx-auto px-container py-12 space-y-8">
          <div className="prose max-w-none">
            <p className="text-text-muted">
              {t("pages_content.services.description")}
            </p>
          </div>
